	...
	tests := []struct {
	...
	}{
		{
			...
			EstimationBillingPeriodUserEntry{
				...
				BillableDays:                  NewFloat(10).Sub(NewFloat(1)).Sub(NewFloat(0.4)).Mul(NewFloat(0.8)),
				NonbillableDays:               NewFloat(10).Sub(NewFloat(10).Sub(NewFloat(1)).Sub(NewFloat(0.4)).Mul(NewFloat(0.8))),
		...
		},
		{
			...
			EstimationBillingPeriodUserEntry{
				...
				BillableDays:                  NewFloat(20).Sub(NewFloat(1)).Sub(NewFloat(2.5)).Mul(NewFloat(0.8)),
				NonbillableDays:               NewFloat(20).Sub(NewFloat(20).Sub(NewFloat(1)).Sub(NewFloat(2.5)).Mul(NewFloat(0.8))),
		...
		},
		{
			...
			EstimationBillingPeriodUserEntry{
				...
				BillableDays:                  NewFloat(20).Sub(NewFloat(0.5)).Sub(NewFloat(2.5)).Mul(NewFloat(0.8)),
				NonbillableDays:               NewFloat(20).Sub(NewFloat(20).Sub(NewFloat(0.5)).Sub(NewFloat(2.5)).Mul(NewFloat(0.8))),
		...
		},
		{
			...
			EstimationBillingPeriodUserEntry{
				...
				SicknessInterestDays:          NewFloat(5).Mul(NewFloat(20).Div(NewFloat(200))),
				BillableDays:                  NewFloat(20).Sub(NewFloat(3.0)).Sub(NewFloat(5)).Mul(NewFloat(0.8)),
				NonbillableDays:               NewFloat(20).Sub(NewFloat(20).Sub(NewFloat(3.0)).Sub(NewFloat(5)).Mul(NewFloat(0.8))),
