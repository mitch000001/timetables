...
func TestBillingPeriodEntryAddTrackingData(t *testing.T) {
	billingPeriodUserEntry := timetables.BillingPeriodUserEntry{
		...
		VacationHours:             timetables.NewRat(8),
		CumulatedVacationHours:    timetables.NewRat(8),
		SicknessHours:             timetables.NewRat(8),
		CumulatedSicknessHours:    timetables.NewRat(8),
...
func TestBillingPeriodEntryAddEstimationData(t *testing.T) {
	forecastPeriodUserEntry := timetables.ForecastBillingPeriodUserEntry{
		...
		RemainingVacationDays:           timetables.NewRat(8),
