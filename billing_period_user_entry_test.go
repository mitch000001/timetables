	...
	tests := []struct {
	...
	}{
		{
			...
			trackedEntries: TrackedHours{
				entries: []TrackingEntry{
					TrackingEntry{Hours: NewRat(8), Type: Billable, UserID: "1", TrackedAt: Date(2015, 1, 1, time.Local)},
					TrackingEntry{Hours: NewRat(8), Type: Billable, UserID: "1", TrackedAt: Date(2015, 1, 2, time.Local)},
					TrackingEntry{Hours: NewRat(8), Type: NonBillable, UserID: "1", TrackedAt: Date(2015, 1, 3, time.Local)},
				},
			},
			output: BillingPeriodUserEntry{
				UserID:                         "1",
		...
		},
		{
			...
			trackedEntries: TrackedHours{
				entries: []TrackingEntry{
					TrackingEntry{Hours: NewRat(8), Type: Billable, UserID: "1", TrackedAt: Date(2015, 1, 1, time.Local)},
					TrackingEntry{Hours: NewRat(8), Type: Billable, UserID: "2", TrackedAt: Date(2015, 1, 2, time.Local)},
					TrackingEntry{Hours: NewRat(8), Type: NonBillable, UserID: "1", TrackedAt: Date(2015, 1, 3, time.Local)},
				},
			},
			output: BillingPeriodUserEntry{
		...
		},
		{
			...
			trackedEntries: TrackedHours{
				entries: []TrackingEntry{
					TrackingEntry{Hours: NewRat(6), Type: Billable, UserID: "2", TrackedAt: Date(2015, 1, 1, time.Local)},
					TrackingEntry{Hours: NewRat(6), Type: Billable, UserID: "2", TrackedAt: Date(2015, 1, 2, time.Local)},
					TrackingEntry{Hours: NewRat(6), Type: NonBillable, UserID: "2", TrackedAt: Date(2015, 1, 3, time.Local)},
				},
			},
			output: BillingPeriodUserEntry{
				UserID:                         "2",
		...
		},
		{
			...
			trackedEntries: TrackedHours{
				entries: []TrackingEntry{
					...
					TrackingEntry{Hours: NewRat(8), Type: Billable, UserID: "1", TrackedAt: Date(2015, 1, 2, time.Local)},
					TrackingEntry{Hours: NewRat(8), Type: NonBillable, UserID: "1", TrackedAt: Date(2015, 1, 3, time.Local)},
					TrackingEntry{Hours: NewRat(8), Type: Vacation, UserID: "1", TrackedAt: Date(2015, 1, 4, time.Local)},
				},
			},
			output: BillingPeriodUserEntry{
				UserID:                         "1",
		...
		},
		{
			...
			trackedEntries: TrackedHours{
				entries: []TrackingEntry{
					...
					TrackingEntry{Hours: NewRat(8), Type: NonBillable, UserID: "1", TrackedAt: Date(2015, 1, 3, time.Local)},
					TrackingEntry{Hours: NewRat(8), Type: Vacation, UserID: "1", TrackedAt: Date(2015, 1, 4, time.Local)},
					TrackingEntry{Hours: NewRat(8), Type: Sickness, UserID: "1", TrackedAt: Date(2015, 1, 5, time.Local)},
				},
			},
			output: BillingPeriodUserEntry{
				UserID:                         "1",
		...
		},
		{
			...
			trackedEntries: TrackedHours{
				entries: []TrackingEntry{
					...
					TrackingEntry{Hours: NewRat(8), Type: Vacation, UserID: "1", TrackedAt: Date(2015, 1, 4, time.Local)},
					TrackingEntry{Hours: NewRat(8), Type: Sickness, UserID: "1", TrackedAt: Date(2015, 1, 5, time.Local)},
					TrackingEntry{Hours: NewRat(8), Type: ChildCare, UserID: "1", TrackedAt: Date(2015, 1, 6, time.Local)},
				},
			},
			output: BillingPeriodUserEntry{
				UserID:                         "1",
		...
		},
		{
			...
			trackedEntries: TrackedHours{
				entries: []TrackingEntry{
					TrackingEntry{Hours: NewRat(8), Type: Billable, UserID: "1", TrackedAt: Date(2015, 2, 1, time.Local)},
					TrackingEntry{Hours: NewRat(8), Type: Billable, UserID: "1", TrackedAt: Date(2015, 2, 2, time.Local)},
					TrackingEntry{Hours: NewRat(8), Type: NonBillable, UserID: "1", TrackedAt: Date(2015, 2, 3, time.Local)},
					TrackingEntry{Hours: NewRat(8), Type: Vacation, UserID: "1", TrackedAt: Date(2015, 2, 4, time.Local)},
					TrackingEntry{Hours: NewRat(8), Type: Sickness, UserID: "1", TrackedAt: Date(2015, 2, 5, time.Local)},
				},
			},
			output: BillingPeriodUserEntry{
				UserID:                         "1",
