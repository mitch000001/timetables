	...
	tests := []struct {
	...
	}{
		{
			...
			output: BillingPeriodUserEntry{
				UserID:                    "1",
				Period:                    Period{"1", date.Timeframe{StartDate: date.Date(2015, 1, 1, time.Local), EndDate: date.Date(2015, 1, 25, time.Local)}, 10},
				VacationHours:             NewRat(0),
				CumulatedVacationHours:    NewRat(0),
				SicknessHours:             NewRat(0),
				CumulatedSicknessHours:    NewRat(0),
		...
		},
		{
			...
			output: BillingPeriodUserEntry{
				UserID:                    "1",
				Period:                    Period{"1", date.Timeframe{StartDate: date.Date(2015, 1, 1, time.Local), EndDate: date.Date(2015, 1, 25, time.Local)}, 10},
				VacationHours:             NewRat(8),
				CumulatedVacationHours:    NewRat(8),
				SicknessHours:             NewRat(0),
				CumulatedSicknessHours:    NewRat(0),
				ChildCareHours:            NewRat(0),
				CumulatedChildCareHours:   NewRat(0),
		...
		},
		{
			...
			output: BillingPeriodUserEntry{
				...
				VacationHours:             NewRat(8),
				CumulatedVacationHours:    NewRat(8),
				SicknessHours:             NewRat(8),
				CumulatedSicknessHours:    NewRat(8),
				ChildCareHours:            NewRat(0),
				CumulatedChildCareHours:   NewRat(0),
				BillableHours:             NewRat(16),
				CumulatedBillableHours:    NewRat(16),
		...
		},
		{
			...
			output: BillingPeriodUserEntry{
				...
				Period:                    Period{"1", date.Timeframe{StartDate: date.Date(2015, 2, 1, time.Local), EndDate: date.Date(2015, 2, 25, time.Local)}, 10},
				VacationHours:             NewRat(8),
				CumulatedVacationHours:    NewRat(16),
				SicknessHours:             NewRat(8),
				CumulatedSicknessHours:    NewRat(16),
				ChildCareHours:            NewRat(0),
				CumulatedChildCareHours:   NewRat(0),
				BillableHours:             NewRat(16),
